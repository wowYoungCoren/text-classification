...
baseUrl = 'http://sports.163.com/special/000587PQ/newsdata_allsports_index{}.js?callback=data_callback'

sportSpider = sportSpyider(baseUrl,headers_sport,5)
sportSpider.startSpyider('sportsnews')