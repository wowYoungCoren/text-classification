...
baseUrl = 'http://money.163.com/special/00259BVP/news_flow_index{}.js?callback=data_callback'

moneySpider = sportSpyider(baseUrl,headers_money,2)
moneySpider.startSpyider('moneynews')